(()=>{
    var img = document.querySelector("#nav .nav_ul .right li:nth-child(3) img");
    var div = document.querySelector("#nav .nav_ul .right li:nth-child(3) .img_hidden");
...
(()=>{
    var img = document.querySelector("#nav .right li:nth-child(5)");
    var ul = document.querySelector("#nav .right li:nth-child(5) .sousuotiao");
    img.onmouseover = function(){
...
(()=>{
    var imgs = document.querySelectorAll("#tuwen3 li dl a img");
    for(var i=0;i<imgs.length;i++){
        var img = imgs[i];
        img.onmouseover = function(){
            this.style.width = "378px";
...
(()=>{
    var imgs = document.querySelectorAll("#two2 div dl a img");
    for(var i=0;i<imgs.length;i++){
        var img = imgs[i];
        img.onmouseover = function(){
            this.style.width = "575px";
...
(()=>{
    var imgs = document.querySelectorAll("#middle-zong2 li dl a img");
    for(var i=0;i<imgs.length;i++){
        var img = imgs[i];
        img.onmouseover = function(){
            this.style.width = "378px";
...
(()=>{
    var imgs = document.querySelectorAll("#two3 div dl a img");
    for(var i=0;i<imgs.length;i++){
        var img = imgs[i];
        img.onmouseover = function(){
            this.style.width = "575px";
